...
def turn_in_list_of_int():
    global random_number_in_list, random_number_in_int_list
    for n in random_number_in_list:
        int_n = int(n)
        random_number_in_int_list.append(int_n)
...
def calculate_ten_digit():
    ...
    while x <= 8:
        multiplied_number = random_number_in_int_list[x] * factors_to_check_tenth_digit[x]
...
def calculate_eleven_digit():
    ...
    while y <= 9:
        new_multiplied_number = random_number_in_int_list[y] * factor_to_check_eleventh_digit[y]
...
random_number_in_list = list(random_number)
random_number_in_int_list = []

for number in random_number_in_list:
    number_as_int = int(number)
    random_number_in_int_list.append(number_as_int)
...
random_number_in_int_list.append(digit_ten)
...
print(random_number + str(digit_ten) + str(digit_eleven))
